...
void main() {
    float a = texture(aim_helper_image, texture_coord_scale*frag_texture_coord + texture_coord_offset).a;
...
@program aim_helper aim_helper_vs aim_helper_fs
