...
typedef vec_t(struct ball_entity) vec_ball_entity_t;

struct physics_triangle {
    vec3 a, b, c;
    float cor, friction, vel_scale;
};
typedef vec_t(struct physics_triangle) vec_physics_triangle_t;
...
typedef vec_t(struct physics_cell) vec_physics_cell_t;
...
struct game {
    ...
    struct {
        ...
        vec_vec3_t water_triangles_dir;
        vec_physics_triangle_t 
            hole_triangles, 
            cup_triangles, 
            water_triangles,
