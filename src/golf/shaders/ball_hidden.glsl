...
void main() {
    vec3 n = texture(normal_map, vec2(frag_texture_coord.x, 1.0 - frag_texture_coord.y)).xyz;
    n = 2.0 * n - 1.0;
...
@program ball_hidden ball_hidden_vs ball_hidden_fs
