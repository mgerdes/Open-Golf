...
/*
    ...
    Overview:
        ...
        Shader program 'aim_helper':
            Get shader desc: aim_helper_shader_desc()
    ...
    Shader descriptor structs:
        ...
        sg_shader aim_helper = sg_make_shader(aim_helper_shader_desc());
    ...
    Bind slot and C-struct for uniform block 'aim_helper_vs_params':
        ...
        sg_apply_uniforms(SG_SHADERSTAGE_[VS|FS], SLOT_aim_helper_vs_params, &aim_helper_vs_params, sizeof(aim_helper_vs_params));
    ...
    Bind slot and C-struct for uniform block 'aim_helper_fs_params':
        ...
        sg_apply_uniforms(SG_SHADERSTAGE_[VS|FS], SLOT_aim_helper_fs_params, &aim_helper_fs_params, sizeof(aim_helper_fs_params));
...
static const char aim_helper_fs_source_glsl330[721] = {
    ...
    0x6c,0x6f,0x61,0x74,0x20,0x5f,0x35,0x37,0x20,0x3d,0x20,0x28,0x61,0x69,0x6d,0x5f,
    0x68,0x65,0x6c,0x70,0x65,0x72,0x5f,0x66,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,
    ...
    0x35,0x37,0x20,0x3e,0x20,0x30,0x2e,0x34,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x35,
    ...
    0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x37,0x30,0x20,0x3d,0x20,0x31,0x2e,0x30,0x20,
    0x2d,0x20,0x28,0x28,0x5f,0x35,0x37,0x20,0x2d,0x20,0x30,0x2e,0x34,0x30,0x30,0x30,
    ...
    0x20,0x28,0x61,0x20,0x2a,0x20,0x5f,0x37,0x30,0x29,0x20,0x2a,0x20,0x5f,0x37,0x30,
...
/*
    ...
    void main()
    {
        ...
        highp float _57 = (aim_helper_fs_params[2].x + ((aim_helper_fs_params[2].y - aim_helper_fs_params[2].x) * frag_texture_coord.x)) / aim_helper_fs_params[2].z;
        if (_57 > 0.4000000059604644775390625)
        {
            highp float _70 = 1.0 - ((_57 - 0.4000000059604644775390625) * 1.66666662693023681640625);
            a = (a * _70) * _70;
        }
        g_frag_color = vec4(aim_helper_fs_params[0].xyz, aim_helper_fs_params[0].w * a);
    }
...
static const char aim_helper_fs_source_glsl300es[812] = {
    ...
    0x69,0x66,0x20,0x28,0x5f,0x35,0x37,0x20,0x3e,0x20,0x30,0x2e,0x34,0x30,0x30,0x30,
    0x30,0x30,0x30,0x30,0x35,0x39,0x36,0x30,0x34,0x36,0x34,0x34,0x37,0x37,0x35,0x33,
    ...
    0x20,0x5f,0x37,0x30,0x20,0x3d,0x20,0x31,0x2e,0x30,0x20,0x2d,0x20,0x28,0x28,0x5f,
    0x35,0x37,0x20,0x2d,0x20,0x30,0x2e,0x34,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x35,
    0x39,0x36,0x30,0x34,0x36,0x34,0x34,0x37,0x37,0x35,0x33,0x39,0x30,0x36,0x32,0x35,
    ...
    0x20,0x5f,0x37,0x30,0x29,0x20,0x2a,0x20,0x5f,0x37,0x30,0x3b,0x0a,0x20,0x20,0x20,
  ...
  #error "Please include sokol_gfx.h before aim_helper.h"
#endif
static inline const sg_shader_desc* aim_helper_shader_desc(void) {
  #if defined(SOKOL_GLCORE33)
