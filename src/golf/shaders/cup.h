...
/*
    ...
    Overview:
        ...
        Shader program 'cup':
            Get shader desc: cup_shader_desc()
    ...
    Shader descriptor structs:
        ...
        sg_shader cup = sg_make_shader(cup_shader_desc());
    ...
    Bind slot and C-struct for uniform block 'cup_vs_params':
        ...
        sg_apply_uniforms(SG_SHADERSTAGE_[VS|FS], SLOT_cup_vs_params, &cup_vs_params, sizeof(cup_vs_params));
...
static const char cup_fs_source_glsl300es[278] = {
  ...
  #error "Please include sokol_gfx.h before cup.h"
#endif
static inline const sg_shader_desc* cup_shader_desc(void) {
  #if defined(SOKOL_GLCORE33)
