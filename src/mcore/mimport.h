...
void mdatafile_add_float(mdatafile_t *file, const char *name, float val, bool user_set);
...
bool mdatafile_get_float(mdatafile_t *file, const char *name, int *float_val);
